...
def project_3d(p2, x3d, y3d, z3d, w3d, h3d, l3d, ry3d, de_norm):
    ...
    R = np.array([[+math.cos(ry3d), 0, +math.sin(ry3d)], [0, 1, 0], [-math.sin(ry3d), 0, +math.cos(ry3d)]])
    ...
    R2 = np.array([[1, 0, 0], [0, -de_norm[1], +de_norm[2]], [0, -de_norm[2], -de_norm[1]]])
...
def project_3d_ground(p2, de_bottom_center, w3d, h3d, l3d, ry3d, de_norm, c2g_trans):
    ...
    verts3d = get_camera_3d_8points_g2c(w3d, h3d, l3d, yaw_world_res, bottom_center_ground, g2c_trans, p2, isCenter=False)
...
def project_3d_world(p2, de_center_in_world, w3d, h3d, l3d, ry3d, camera2world):
    ...
    yaw_world_res = math.atan2(theta0[1], theta0[0])
    verts3d = get_camera_3d_8points_g2c(w3d, h3d, l3d, yaw_world_res, center_world[:3, :], world2camera, p2, isCenter=False)
...
def get_camera_3d_8points_g2c(w3d, h3d, l3d, yaw_ground, center_ground, g2c_trans, p2, isCenter=True):
    """
    ...
    isCenter:
        ...
        0: bottom
    """
    ground_r = np.matrix([[math.cos(yaw_ground), -math.sin(yaw_ground), 0], [math.sin(yaw_ground), math.cos(yaw_ground), 0], [0, 0, 1]])
    # l, w, h = obj_size
    w = w3d
    l = l3d
    h = h3d
    ...
    if isCenter:
        ...
        corners_3d_ground = np.matrix(
            [[l / 2, l / 2, -l / 2, -l / 2, l / 2, l / 2, -l / 2, -l / 2], [w / 2, -w / 2, -w / 2, w / 2, w / 2, -w / 2, -w / 2, w / 2], [0, 0, 0, 0, h, h, h, h]]
        )
