...
def show_groundpoints(name_list):
    ...
    for i, name in enumerate(name_list):
        ...
        for ind in range(points_2d.shape[1]):
            ...
            cv2.circle(
                img, point, 2, (0, 255, 0),
                3)  # pointsize = 2, point_color = (255, 0, 0), thickness = 3
