...
def _parse_coco_ann_info(ann_info):
    ...
    for _i, ann in enumerate(ann_info):
...
class GTDatabaseCreater:
    ...
    def create(self):
        ...
        multi_db_infos = mmengine.track_parallel_progress(self.create_single, ((loop_dataset(i) for i in range(len(self.dataset))), len(self.dataset)), self.num_worker)
