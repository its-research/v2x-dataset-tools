...
import numpy as np
from gen_kitti.utils import read_json
...
def trans_lidar_i2v(
    ...
    if system_error_offset is not None:
        inf_lidar2world_t[0][0] = (
            inf_lidar2world_t[0][0] + system_error_offset['delta_x'])
        inf_lidar2world_t[1][0] = (
            inf_lidar2world_t[1][0] + system_error_offset['delta_y'])
