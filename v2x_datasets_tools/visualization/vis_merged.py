...
dair_path = {
    'single':
    'logs/dair_single_late_2022_09_22_20_19_14',
    'disconet':
    'logs/dair_disconet_2022_09_22_20_27_45',
    'when2com':
    'logs/dair_when2com_2022_09_22_23_07_02',
    'where2comm':
    'bp_logs/dair_npj_where2comm_multiscale_resnet_max_2022_09_14_23_08_17',
}

v2x_path = {
    'single':
    'logs/v2x2_single_2022_09_22_01_28_30',
    'late':
    'logs/v2x2_single_late_2022_09_22_01_28_30',
    'where2comm':
    'logs/v2x2_npj_where2comm_multiscale_resnet_max_2022_09_22_01_17_57',
}
...
def merge_img(img_id, picked_model, align='row', mode='3d'):
    ...
    image_save_path = os.path.join(root_save_path, mode,
                                   '{:05d}.png'.format(img_id))
...
for start_id in range(start_idx, end_idx, gap):
    ...
    for mode, align in zip(['bev', '3d'], ['col', 'row']):
        ...
        out = cv2.VideoWriter(
            os.path.join(
                root_save_path,
                'result_video/{}_{}_{}_{}.mp4'.format(dataset, mode, start_id,
                                                      end_id),
            ),
