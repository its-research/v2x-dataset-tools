...
def visualize(
    ...
    """Visualize the prediction, ground truth with point cloud together. They
    may be flipped in y axis. Since carla is left hand coordinate, while kitti
    is right hand.
    ...
    if vis_pred_box:
        ...
        if uncertainty is not None:
            ...
            if uncertainty_np.shape[1] == 3:
                ...
                uncertainty_np[:, :2] *= d_a_square
                uncertainty_np = np.sqrt(
                    uncertainty_np)  # yaw angle is in radian
