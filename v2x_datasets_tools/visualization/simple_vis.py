    ...
    if vis_pred_box:
        ...
        if uncertainty is not None:
            ...
            if uncertainty_np.shape[1] == 3:
                ...
                pred_name = [f"x_u:{uncertainty_np[i,0]:.3f} y_u:{uncertainty_np[i,1]:.3f} a_u:{uncertainty_np[i,2]:.3f}" for i in range(uncertainty_np.shape[0])]
                ...
                pred_name = [f"x_u:{uncertainty_np[i,0]:.3f} y_u:{uncertainty_np[i,1]:3f} a_u:{uncertainty_np[i,6]:3f}" for i in range(uncertainty_np.shape[0])]
