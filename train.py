...
if __name__ == '__main__':
    ...
    # parser.add_argument('--root', type=str, default="/home/lxy/hivt-v2x1/data",required=False)
    parser.add_argument('--root', type=str, default="/home/lxy/hivt-v2x1/data_1",required=False)
    # parser.add_argument('--root', type=str, default="/home/lxy/argo1_data/argoverse1",required=False)
