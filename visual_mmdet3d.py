...
cam2img = np.array(info_file["data_list"][22]["images"]["CAM2"]["cam2img"], dtype=np.float32)
bboxes_3d = []
...
visualizer = Det3DLocalVisualizer(vis_backends=[dict(type="LocalVisBackend")], save_dir="./outputs/")
